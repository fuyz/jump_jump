...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.01fbc.js';
        if (jsList) {
...
// main.e1e6e.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
